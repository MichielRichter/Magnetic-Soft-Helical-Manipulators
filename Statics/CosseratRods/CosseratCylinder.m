classdef CosseratCylinder
    ...
    methods
        ...
        function obj = CosseratCylinder(length, radius_outer, ...
            ...
            % Derived properties
            % area moments of inertia for outer cylinder
            moment_area_x = pi * (radius_outer^4 - radius_inner^4) / 4;
            moment_area_y = pi * (radius_outer^4 - radius_inner^4) / 4;
            moment_area_z = moment_area_x + moment_area_y;
            
            % Derived properties
            % area moments of inertia for backbone
            ...
            stiffness_bending = diag([elastic_modulus, elastic_modulus, shear_modulus]) * ...
            ...
            stiffness_shear = diag([shear_modulus, shear_modulus, elastic_modulus]) * ...
                (pi * (radius_outer^2-radius_inner^2));
            ...
            obj.Kb = stiffness_bending + stiffness_bending_backbone;
            obj.Ks = stiffness_shear + stiffness_shear_backbone;
