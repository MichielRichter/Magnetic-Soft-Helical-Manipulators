...
width = (length_helix - number_of_windings * pitch) / (2 + number_of_windings);
...
Disc = CosseratCylinder(width, radius_magnet_outer, ...
    radius_magnet_inner, radius_backbone_outer, radius_backbone_inner, ...
...
Helix = CosseratHelix(length_helix-2*width, radius_helix_outer, ...
